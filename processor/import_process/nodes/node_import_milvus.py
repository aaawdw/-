...
from processor.import_process.exceptions import StateFieldError, MilvusError
...
class NodeImportMilvus(BaseNode):
    ...
    def _step_4_insert_data(self, client, chunks_json_data):
        ...
        self.logger.info(f"成功插入 {len(chunks_json_data)} 条数据到 Milvus")
